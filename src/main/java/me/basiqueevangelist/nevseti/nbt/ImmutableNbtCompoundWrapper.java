...
public class ImmutableNbtCompoundWrapper implements me.basiqueevangelist.nevseti.nbt.NbtCompoundView {
    ...
    @Override
    public me.basiqueevangelist.nevseti.nbt.NbtCompoundView getCompound(String key) {
        return NbtCompoundView.take(tag.getCompound(key));
    }
    
    @Override
    public me.basiqueevangelist.nevseti.nbt.NbtListView getList(String key, int type) {
